...
export default () => (
  <Layout hideNav={true}>
    ...
    <Paragraph>
      This website is operated by Vois. Throughout the site, the terms “we”,
      “us” and “our” refer to Vois. Vois offers this website, including all
      ...
      notices stated here. By visiting our site and/ or purchasing something
      ...
      limited to these Terms of Service. You can review the most current version
    ...
    <Heading level={2}> SECTION 2 - GENERAL CONDITIONS</Heading>
    <Paragraph>
    ...
    <Heading level={2}>SECTION 5 - OPTIONAL TOOLS</Heading>
    <Paragraph>
    ...
    <Heading level={2}>SECTION 6 - THIRD-PARTY LINKS </Heading>
    <Paragraph>
    ...
    <Heading level={2}>SECTION 8 - PROHIBITED USES </Heading>
    <Paragraph>
    ...
    <Paragraph>
      ...
      durability, title, and non-infringement. In no case shall Vois, our
    ...
    <Heading level={2}> SECTION 10 - INDEMNIFICATION</Heading>
    <Paragraph>
      You agree to indemnify, defend and hold harmless Vois and our parent,
    ...
    <Heading level={2}>SECTION 11 - SEVERABILITY</Heading>
    <Paragraph>
    ...
    <Heading level={2}>SECTION 12 - TERMINATION </Heading>
    <Paragraph>
    ...
    <Heading level={2}>SECTION 13 - ENTIRE AGREEMENT</Heading>
    <Paragraph>
    ...
    <Heading level={2}>SECTION 14 - CHANGES TO TERMS OF SERVICE </Heading>
    <Paragraph>
      ...
      <Heading level={2}> SECTION 20 - CONTACT INFORMATION </Heading>
      <Paragraph>
